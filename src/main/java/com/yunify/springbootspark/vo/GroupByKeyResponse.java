...
public class GroupByKeyResponse extends Response {
    ...
    public GroupByKeyResponse(int taskStatus, List<Tuple2<String, String>> distributedDataset, int errorCode, String errorMsg){
        super(taskStatus, errorCode, errorMsg);
        this.distributedDataset = distributedDataset;
    }

    public static GroupByKeyResponse getResponse(ErrorCodeEnum errorCodeEnum, List<Tuple2<String, String>> distributedDataset){
